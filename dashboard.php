...
<div class="row" id="bar">
    <div class="col-sm-10 heading" id="up">TiptoTrip</div>
...
if(isset($_POST['deleteTrip']))
{
    ...
    if($resultx == True)
    {
		...
		require("C:\wamp64\www\travel\PHPmailer\src\PHPMailer.php");
		require("C:\wamp64\www\travel\PHPmailer\src\SMTP.php");
		require("C:\wamp64\www\travel\PHPmailer\src\Exception.php");
	    $mail = new PHPMailer;
