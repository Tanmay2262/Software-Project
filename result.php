...
<body style="background-color: #000000;">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand heading" href="home.php?status=loggedin"><b>TiptoTrip</b></a>
    ...
    if(isset($_POST['GetResult']))
    {
        ...
        if(!empty($_POST['category']) || !empty($_POST['group']))
        {
            ...
            else
            {
                ...
                if($count == 0)
                {
                    echo '<div class="alert alert-danger" role="alert">
                            <strong>Sorry!</strong> No recommendations found.
                        </div>';
                }
                else
                {
                    echo '<div class="alert alert-success" role="alert">
                            <strong>Success!</strong> '.$count.' recommendations found.
                        </div>';
                    while($row = mysqli_fetch_assoc($result))
                    {
                        echo '<div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="'.$row['Link'].'" class="btn btn-primary">Go to website</a>
                                </div>
                            </div>';
                    }
                }
            ...
            if($rows==0)
            {
                ...
                <div class="info">
                    <p style="color: #fafafa;">We are sorry! We could not find any location to match your requirements. Click <a href="home.php?status=loggedin">here</a> to browse other trips planned by TiptoTrip.</p>
                </div>
            </div>';
            }
        }
